...
contract StackUp {
    ...
    // function that allows admin to delete quests
    function deleteQuest(uint256 questId) external {
        ...
        // Delete the quest from storage
        delete quests[questId];
        delete playerQuestStatuses[address(0)][questId];
    }

    // function that allows admin to edit quests
    function editQuest(
        uint256 questId,
        ...
        // verify that msg.sender is the admin
